...
# 2. Modern Ultra-Clear Dark Theme CSS
st.markdown(
    """
    <style>
...
# --- 6. Input Handler & Active Model Pipeline ---
if prompt := st.chat_input("Ask ProAi..."):
    ...
    with st.chat_message("assistant", avatar="⚡"):
        ...
        # Active Groq LLM Text Route
        else:
            with st.spinner("Pro AI reply taiyar kar raha hai..."):
                clean_api_msgs = [
                    {"role": "system", "content": "You are 'Pro AI', an ultra-intelligent AI assistant created by Kishan Singh. Support Hindi, English, and all global languages fluently. Provide accurate, helpful, and direct answers."}
                ]
                ...
                # List of 100% verified active Groq models
                active_models = [
